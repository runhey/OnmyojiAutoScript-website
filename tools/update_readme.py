...
![Static Badge](https://img.shields.io/badge/platform-Windows-blueviolet)

![Static Badge license](https://img.shields.io/github/license/runhey/OnmyojiAutoScript)
![Static Badge repo size](https://img.shields.io/github/repo-size/runhey/OnmyojiAutoScript)
![Static Badge all releases](https://img.shields.io/github/downloads/runhey/OnmyojiAutoScript/total)
![Static Badge stars](https://img.shields.io/github/stars/runhey/OnmyojiAutoScript?style=social)
'''
...
if __name__ == "__main__":
    ...
    with open("docs/user-manual/getting-started.md", "w", encoding="utf-8") as f:
        f.write(readme)
